          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-border flex items-center justify-between gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-1.5 font-bold text-xs px-3 py-1.5 rounded-btn bg-indigo text-white hover:bg-indigo-deep transition-all shadow-xs whitespace-nowrap"
              >
                Read revision guide
              ...
              {article.readTime && (
                <span className="text-micro text-slate-light ml-auto">{article.readTime}</span>
              )}
            </div>
          </Card>
        ))}
